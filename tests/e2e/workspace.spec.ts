...
test('create, edit, reload and safely delete a real local project',async({page})=>{
 ...
 await page.getByRole('button',{name:'Delete this space',exact:true}).click();await expect(page.getByRole('alertdialog')).toBeVisible()
 await page.getByRole('alertdialog').getByRole('button',{name:'Cancel',exact:true}).click();await expect(page.getByRole('heading',{name:'Updated apartment',exact:true})).toBeVisible()
 await page.getByRole('button',{name:'Delete this space',exact:true}).click();await page.getByRole('alertdialog').getByRole('button',{name:'Delete space',exact:true}).click()
